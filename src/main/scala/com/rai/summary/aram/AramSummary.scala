...
/**
 * Finds the basic stats of each champion, item, mastery, rune, and summoner spell
 */
class AramSummary extends RiotApi {
  val system = ActorSystem("AramSummary")
...
object AramSummary {
  def main(args: Array[String]) {
    ...
    val crawler = system.actorOf(Props(new AramSummary))
